...
function StatisticsCIS() {
    return (
        <div id="stats" className="w-[100%] h-[400px] relative bg-[#102c3c] overflow-hidden z-10">
            ...
            />
            <p className="text-center text-5xl underline z-[5] absolute top-1/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[100%] text-white font-['Arima'] font-semibold">
                Statistics
            </p>
